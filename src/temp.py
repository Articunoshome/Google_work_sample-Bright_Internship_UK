# -*- coding: utf-8 -*-
"""
Created on Thu Jul  1 00:46:40 2021
...
class VideoPlayer:
    ...
    def show_all_videos(self):
        ...
        for i in range(num_videos):
            ...
            print(str(self._video_library.get_all_videos()[i].title+" "+self._video_library.get_all_videos()[i].video_id
    ...
    def show_playing(self):
        ...
        if "T" in Status:
            i = Status.index("T")
            print("Current playing: "+str(self._video_library.get_all_videos()[i].title+" "+self._video_library.get_all_videos()[i].video_id
                  +" "+str(list(self._video_library.get_all_videos()[i].tags))))
        if "P" in Status:
            i = Status.index("P")
            print("Current playing: "+str(self._video_library.get_all_videos()[i].title+" "+self._video_library.get_all_videos()[i].video_id
    ...
    def add_to_playlist(self, playlist_name, video_id):
        ...
        if video_id not in ids:
            ...
            title = str(self._video_library.get_video(video_id).title+" "+video_id+" "+str(list(self._video_library.get_video(video_id).tags)))
    ...
    def search_videos(self, search_term):
        ...
        Present = ['']*(num_videos)
        for i in range(num_videos):
            if search_term in self._video_library.get_all_videos()[i].title:
                Present[i]='p'
        if 'p' not in Present:
    ...
    def allow_video(self, video_id):
        ...
        if video_id not in ids:
            ...
            print("Successfully removed flagged video: "+self._video_library.get_video(video_id).title)
